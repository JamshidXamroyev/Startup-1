...
const AllProduct = () => {
  return (
    <>
        <section className="flex justify-start my-8 nt:flex-row flex-col nt:mx-0 mx-4 border-b-2 py-5">
            <div className="nt:w-1/3 w-full mx-auto">
                <h4 className="pl:text-4xl font-bold font-titleFont mb-3">Siz xohlagan <br /> Barcha mahsulotlar <br />Tezda yetkazib beriladi.</h4>
